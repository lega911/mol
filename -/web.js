...
(function ($) {
    var $mol_portion_indicator = (function (_super) {
        ...
        $mol_portion_indicator.prototype.style = function () {
            return (__assign({}, _super.prototype.style.call(this), { "width": this.widthStyle() }));
        };
    ...
    var $mol_select = (function (_super) {
        ...
        $mol_select.prototype.Filter_string = function () {
            ...
            return new $.$mol_string().setup(function (obj) {
                obj.autofocus = function () { return true; };
...
(function ($) {
    var $mol_app_supplies_card_demo_pending = (function (_super) {
        ...
        $mol_app_supplies_card_demo_pending.prototype.arg = function () {
            return (__assign({}, _super.prototype.arg.call(this), { "supply": "1" }));
        };
...
(function ($) {
    var $mol_app_supplies_card_demo_approved = (function (_super) {
        ...
        $mol_app_supplies_card_demo_approved.prototype.arg = function () {
            return (__assign({}, _super.prototype.arg.call(this), { "supply": "2" }));
        };
...
(function ($) {
    var $mol_html_meta = (function (_super) {
        ...
        $mol_html_meta.prototype.attr = function () {
            return (__assign({}, _super.prototype.attr.call(this), { "name": this.name(), "content": this.content(), "charset": this.charset() }));
        };
...
(function ($) {
    var $mol_html_link = (function (_super) {
        ...
        $mol_html_link.prototype.attr = function () {
            return (__assign({}, _super.prototype.attr.call(this), { "rel": this.rel(), "href": this.href() }));
        };
...
(function ($) {
    var $mol_meter_demo = (function (_super) {
        ...
        $mol_meter_demo.prototype.Top = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat("Offset from top is ", _this.top(), "px"); };
            });
        };
        $mol_meter_demo.prototype.Height = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat("Component height is ", _this.height(), "px"); };
            });
        };
...
(function ($) {
    var $mol_nav_demo = (function (_super) {
        ...
        $mol_nav_demo.prototype.title = function () {
            return "Focus me and navigate (arrows up & down)!";
        };
        ...
        $mol_nav_demo.prototype.content = function () {
        ...
        $mol_nav_demo.prototype.plugins = function () {
            return [].concat(this.Nav());
        };
        return $mol_nav_demo;
    }($.$mol_labeler));
...
(function ($) {
    var $mol_pop_demo = (function (_super) {
        ...
        $mol_pop_demo.prototype.Show = function () {
            ...
            return new $.$mol_button().setup(function (obj) {
                ...
                obj.sub = function () { return [].concat("Show Bubble"); };
            });
        };
        ...
        $mol_pop_demo.prototype.Hide = function () {
            ...
            return new $.$mol_button().setup(function (obj) {
                ...
                obj.sub = function () { return [].concat("Hide Bubble"); };
            });
        };
        $mol_pop_demo.prototype.Content = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(" I'm bubble, i showed when you want ", _this.Hide()); };
            });
        };
        ...
        $mol_pop_demo.prototype.Select_label = function () {
            var _this = this;
            return new $.$mol_labeler().setup(function (obj) {
                obj.title = function () { return "align"; };
                obj.Content = function () { return new $.$mol_select().setup(function (obj) {
                    ...
                    obj.options = function () { return [].concat("left_top", "left_center", "left_bottom", "right_top", "right_center", "right_bottom", "center", "top_left", "top_center", "top_right", "bottom_left", "bottom_center", "bottom_right"); };
                }); };
            });
        };
        $mol_pop_demo.prototype.sub = function () {
            return [].concat(this.Pop(), this.Select_label());
        };
        return $mol_pop_demo;
    }($.$mol_row));
    __decorate([
    ...
    __decorate([
        $.$mol_mem()
    ], $mol_pop_demo.prototype, "Select_label", null);
...
(function ($) {
    var $mol_pop_over_demo = (function (_super) {
        ...
        $mol_pop_over_demo.prototype.align = function () {
            return "bottom_right";
        };
        $mol_pop_over_demo.prototype.Anchor = function () {
            return "File";
        };
        $mol_pop_over_demo.prototype.Open = function () {
            return new $.$mol_row().setup(function (obj) {
                obj.sub = function () { return [].concat("Open"); };
            });
        };
        $mol_pop_over_demo.prototype.Export = function () {
            return new $.$mol_row().setup(function (obj) {
                obj.sub = function () { return [].concat("Export"); };
            });
        };
        $mol_pop_over_demo.prototype.Save = function () {
            return new $.$mol_row().setup(function (obj) {
                obj.sub = function () { return [].concat("Save"); };
            });
        };
        $mol_pop_over_demo.prototype.Menu = function () {
            var _this = this;
            return new $.$mol_list().setup(function (obj) {
                obj.rows = function () { return [].concat(_this.Open(), _this.Export(), _this.Save()); };
            });
        };
        $mol_pop_over_demo.prototype.bubble_content = function () {
...
(function ($) {
    var $mol_select_demo_colors = (function (_super) {
        ...
        $mol_select_demo_colors.prototype.Content = function () {
            var _this = this;
            return new $.$mol_select().setup(function (obj) {
    ...
    __decorate([
        $.$mol_mem()
    ], $mol_select_demo_colors.prototype, "Content", null);
...
var $;
(function ($) {
    var $mol_select_demo_search = (function (_super) {
        __extends($mol_select_demo_search, _super);
        function $mol_select_demo_search() {
            return _super.apply(this, arguments) || this;
        }
        $mol_select_demo_search.prototype.title = function () {
            return "Month";
        };
        $mol_select_demo_search.prototype.month = function (val) {
            return (val !== void 0) ? val : "";
        };
        $mol_select_demo_search.prototype.months = function () {
            return ({
                "jan": "January",
                "feb": "February",
                "mar": "March",
        ...
        $mol_select_demo_search.prototype.Content = function () {
            var _this = this;
            return new $.$mol_select().setup(function (obj) {
                obj.no_options_message = function () { return "Not found"; };
                obj.value = function (val) { return _this.month(val); };
                obj.dictionary = function () { return _this.months(); };
            });
        };
        return $mol_select_demo_search;
    }($.$mol_labeler));
    __decorate([
        $.$mol_mem()
    ], $mol_select_demo_search.prototype, "month", null);
    __decorate([
        $.$mol_mem()
    ], $mol_select_demo_search.prototype, "Content", null);
    $.$mol_select_demo_search = $mol_select_demo_search;
})($ || ($ = {}));
//search.view.tree.js.map
;
var __extends = (this && this.__extends) || function (d, b) {
...
var $;
(function ($) {
    var $mol_select_demo_strings = (function (_super) {
        __extends($mol_select_demo_strings, _super);
        function $mol_select_demo_strings() {
            return _super.apply(this, arguments) || this;
        }
        $mol_select_demo_strings.prototype.title = function () {
            return "Priority";
        };
        $mol_select_demo_strings.prototype.priority = function (val) {
            return (val !== void 0) ? val : "Lowest";
        };
        $mol_select_demo_strings.prototype.Content = function () {
            var _this = this;
            return new $.$mol_select().setup(function (obj) {
        ...
        return $mol_select_demo_strings;
    }($.$mol_labeler));
    __decorate([
        $.$mol_mem()
    ], $mol_select_demo_strings.prototype, "priority", null);
    __decorate([
        $.$mol_mem()
    ], $mol_select_demo_strings.prototype, "Content", null);
    $.$mol_select_demo_strings = $mol_select_demo_strings;
})($ || ($ = {}));
//strings.view.tree.js.map
;
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
(function ($) {
    var $mol_switch_demo_enabled = (function (_super) {
        ...
        $mol_switch_demo_enabled.prototype.options = function () {
            return (__assign({}, _super.prototype.options.call(this), { "red": this.option_red(), "green": this.option_green(), "blue": this.option_blue() }));
        };
...
(function ($) {
    var $mol_webdav = (function (_super) {
        ...
        $mol_webdav.prototype.info_tree = function () {
            var dom = this.request().response().responseXML;
            var responses = dom.querySelectorAll('response');
            var base = this.uri().replace(/\/[^\/]*$/, '');
            var info = {};
            for (var _i = 0, responses_1 = responses; _i < responses_1.length; _i++) {
                var response = responses_1[_i];
                var uri = base + response.querySelector('href').textContent;
                var type = response.querySelector('resourcetype > collection') ? 'dir' : 'file';
                var common = {
                ...
                switch (type) {
                    case 'dir':
                        info[uri] = __assign({}, common, { type: 'dir' });
                        break;
                    case 'file':
                        info[uri] = __assign({}, common, { type: 'file', size: Number(response.querySelector('getcontentlength').textContent), version: response.querySelector('getetag').textContent, mime: response.querySelector('getcontenttype').textContent });
                        break;
                }
            }
            return info;
        };
        $mol_webdav.prototype.info_self = function () {
            this.parent().info_tree();
        };
        $mol_webdav.prototype.sub = function () {
            var next = [];
            for (var uri in this.info_tree()) {
                if (uri == this.uri())
                    continue;
        ...
        $mol_webdav.prototype.title = function () {
            return this.info_self()[this.uri()].title;
        };
        $mol_webdav.prototype.created = function () {
            return this.info_self()[this.uri()].created;
        };
        $mol_webdav.prototype.size = function () {
            return this.info_self()[this.uri()].size;
        };
        $mol_webdav.prototype.mime = function () {
            return this.info_self()[this.uri()].mime;
        };
        $mol_webdav.prototype.version = function () {
    ...
    __decorate([
        $.$mol_mem()
    ], $mol_webdav.prototype, "info_tree", null);
    __decorate([
        $.$mol_mem()
